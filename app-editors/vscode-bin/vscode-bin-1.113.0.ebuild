...
SRC_URI="
amd64? ( https://update.code.visualstudio.com/1.113.0/linux-x64/stable -> vscode-bin-linux-x64-1.113.0.tar.gz )
arm64? ( https://update.code.visualstudio.com/1.113.0/linux-arm64/stable -> vscode-bin-linux-arm64-1.113.0.tar.gz )"
LICENSE="Apache-2.0
BSD
BSD-1
BSD-2
