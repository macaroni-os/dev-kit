...
SRC_URI="
amd64? ( https://update.code.visualstudio.com/1.108.2/linux-x64/stable -> vscode-bin-linux-x64-1.108.2.tar.gz )
arm64? ( https://update.code.visualstudio.com/1.108.2/linux-arm64/stable -> vscode-bin-linux-arm64-1.108.2.tar.gz )"
LICENSE="Apache-2.0
BSD
BSD-1
BSD-2
