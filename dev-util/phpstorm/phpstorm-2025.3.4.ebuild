...
SRC_URI="
amd64? ( https://download.jetbrains.com/webide/PhpStorm-2025.3.4.tar.gz -> phpstorm-2025.3.4-amd64.tar.gz )
arm64? ( https://download.jetbrains.com/webide/PhpStorm-2025.3.4-aarch64.tar.gz -> phpstorm-2025.3.4-aarch64.tar.gz )"
LICENSE="JetBrains"
SLOT="0"
KEYWORDS="*"
...
post_src_unpack() {
	if [ ! -d "$S" ]; then
	  ...
	  mv $(ls "${WORKDIR}") "PhpStorm-2025.3.4" || die
	fi
}
src_install() {
