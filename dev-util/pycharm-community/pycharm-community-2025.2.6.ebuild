...
SRC_URI="
amd64? ( https://download.jetbrains.com/python/pycharm-community-2025.2.6.tar.gz -> pycharm-community-2025.2.6-amd64.tar.gz )
arm64? ( https://download.jetbrains.com/python/pycharm-community-2025.2.6-aarch64.tar.gz -> pycharm-community-2025.2.6-aarch64.tar.gz )"
LICENSE="JetBrains"
SLOT="0"
KEYWORDS="*"
...
post_src_unpack() {
	if [ ! -d "$S" ]; then
	  ...
	  mv $(ls "${WORKDIR}") "pycharm-2025.2.6" || die
	fi
}
src_install() {
