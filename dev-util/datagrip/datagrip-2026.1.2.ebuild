...
SRC_URI="
amd64? ( https://download.jetbrains.com/datagrip/datagrip-2026.1.2.tar.gz -> datagrip-2026.1.2-amd64.tar.gz )
arm64? ( https://download.jetbrains.com/datagrip/datagrip-2026.1.2-aarch64.tar.gz -> datagrip-2026.1.2-aarch64.tar.gz )"
LICENSE="JetBrains"
SLOT="0"
KEYWORDS="*"
...
post_src_unpack() {
	if [ ! -d "$S" ]; then
	  ...
	  mv $(ls "${WORKDIR}") "DataGrip-2026.1.2" || die
	fi
}
src_install() {
