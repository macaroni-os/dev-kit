...
SRC_URI="
amd64? ( https://download.jetbrains.com/datagrip/datagrip-2026.2.1.tar.gz -> datagrip-2026.2.1-amd64.tar.gz )
arm64? ( https://download.jetbrains.com/datagrip/datagrip-2026.2.1-aarch64.tar.gz -> datagrip-2026.2.1-aarch64.tar.gz )"
LICENSE="JetBrains"
SLOT="0"
KEYWORDS="*"
