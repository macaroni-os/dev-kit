...
SRC_URI="
amd64? ( https://download.jetbrains.com/python/pycharm-2025.3.tar.gz -> pycharm-professional-2025.3-amd64.tar.gz )
arm64? ( https://download.jetbrains.com/python/pycharm-2025.3-aarch64.tar.gz -> pycharm-professional-2025.3-aarch64.tar.gz )"
LICENSE="JetBrains"
SLOT="0"
KEYWORDS="*"
...
post_src_unpack() {
	if [ ! -d "$S" ]; then
	  ...
	  mv $(ls "${WORKDIR}") "pycharm-2025.3" || die
	fi
}
src_install() {
