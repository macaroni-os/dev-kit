...
SRC_URI="
amd64? ( https://download.jetbrains.com/python/pycharm-2025.2.4.tar.gz -> pycharm-professional-2025.2.4-amd64.tar.gz )
arm64? ( https://download.jetbrains.com/python/pycharm-2025.2.4-aarch64.tar.gz -> pycharm-professional-2025.2.4-aarch64.tar.gz )"
LICENSE="JetBrains"
SLOT="0"
KEYWORDS="*"
