...
SRC_URI="
amd64? ( https://download.jetbrains.com/webstorm/WebStorm-2025.3.2.tar.gz -> webstorm-2025.3.2-amd64.tar.gz )
arm64? ( https://download.jetbrains.com/webstorm/WebStorm-2025.3.2-aarch64.tar.gz -> webstorm-2025.3.2-aarch64.tar.gz )"
LICENSE="JetBrains"
SLOT="0"
KEYWORDS="*"
...
post_src_unpack() {
	if [ ! -d "$S" ]; then
	  ...
	  mv $(ls "${WORKDIR}") "webstorm-2025.3.2" || die
	fi
}
src_install() {
