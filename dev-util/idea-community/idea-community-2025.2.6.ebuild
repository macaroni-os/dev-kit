...
SRC_URI="
amd64? ( https://download.jetbrains.com/idea/ideaIC-2025.2.6.tar.gz -> idea-community-2025.2.6-amd64.tar.gz )
arm64? ( https://download.jetbrains.com/idea/ideaIC-2025.2.6-aarch64.tar.gz -> idea-community-2025.2.6-aarch64.tar.gz )"
LICENSE="JetBrains"
SLOT="0"
KEYWORDS="*"
...
"
S="${WORKDIR}/idea-IC-2025.2.6"
post_src_unpack() {
	if [ ! -d "$S" ]; then
	  einfo "Renaming source directory to predictable name..."
	  mv $(ls "${WORKDIR}") "idea-IC-2025.2.6" || die
	fi
}
src_install() {
