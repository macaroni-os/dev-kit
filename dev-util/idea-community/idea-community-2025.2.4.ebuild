...
SRC_URI="
amd64? ( https://download.jetbrains.com/idea/ideaIC-2025.2.4.tar.gz -> idea-community-2025.2.4-amd64.tar.gz )
arm64? ( https://download.jetbrains.com/idea/ideaIC-2025.2.4-aarch64.tar.gz -> idea-community-2025.2.4-aarch64.tar.gz )"
LICENSE="JetBrains"
SLOT="0"
KEYWORDS="*"
...
post_src_unpack() {
	if [ ! -d "$S" ]; then
	  ...
	  mv $(ls "${WORKDIR}") "idea-IC-2025.2.4" || die
	fi
}
src_install() {
