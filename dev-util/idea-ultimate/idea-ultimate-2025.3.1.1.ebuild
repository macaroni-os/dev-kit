...
SRC_URI="
amd64? ( https://download.jetbrains.com/idea/ideaIU-2025.3.1.1.tar.gz -> idea-ultimate-2025.3.1.1-amd64.tar.gz )
arm64? ( https://download.jetbrains.com/idea/ideaIU-2025.3.1.1-aarch64.tar.gz -> idea-ultimate-2025.3.1.1-aarch64.tar.gz )"
LICENSE="JetBrains"
SLOT="0"
KEYWORDS="*"
...
post_src_unpack() {
	if [ ! -d "$S" ]; then
	  ...
	  mv $(ls "${WORKDIR}") "idea-IU-2025.3.1.1" || die
	fi
}
src_install() {
